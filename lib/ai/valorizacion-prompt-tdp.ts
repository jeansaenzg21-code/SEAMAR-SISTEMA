export const VALORIZACION_PROMPT_TDP = `
...
Extraer del encabezado del documento.
...
2. Si NO existe una columna "Proyecto", utilizar EXCLUSIVAMENTE el valor del campo "Negocio / Operación" como proyecto.
...
La descripción SIEMPRE debe obtenerse de la columna "Descripción".

...
- modelo: valor de "MODELO:" o columna MODELO. Ej: HS-50F. Si no, null. Usa tu criterio para decidir si un código del bien es su MODELO o es la REFERENCIA del producto (código de parte). Regla práctica: el MODELO suele estar asociado a la etiqueta "MODELO:"/"MOD." o aparece como un código corto dentro del nombre/descripción que identifica la variante del equipo (ej: en "Fuente de luz para endoscopio HB300L (CE, LED)" el modelo es "HB300L"). El código de REFERENCIA/PARTE es el que aparece al INICIO de la línea precediendo a la descripción (ej: "F04GB-PA00008 Sistema de cámara...", "115-056312-00 Bandeja Rigida para Endoscopio", "120-004559-00 Endoscopio rígido...") y NO es modelo: se queda tal cual al inicio de la descripcion. Decide con el contexto de cada fila; cuando dudes, deja el código en la descripción y modelo = null. IMPORTANTE: NUNCA trates una medida/dimensión como modelo (ej: "10mm", "4.8x3M", "4.8*3M", "30°", "2KVA", "31 pulgadas", "1.5L", "5cm"): esas medidas SIEMPRE pertenecen a la descripción y se mantienen en ella.
...
3. Los códigos de REFERENCIA/PARTE que aparecen al inicio de una línea de descripción —ya sean numéricos largos ("100208649 8065753152") o códigos con guiones ("115-056312-00", "F04GB-PA00008", "120-004559-00", "BGP-FW-S1")— NO van a codigoBien ni a ref: se conservan tal cual al inicio de la descripcion del bien. Si además parecen un modelo legítimo según el contexto (ver campo modelo), puedes extraerlos a modelo; en caso de duda, déjalos en la descripción. Nunca los borres ni los omitas.
